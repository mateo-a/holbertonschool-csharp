...
/// <summary>class called RoomObjects</summary>
class RoomObjects
{
    /// <summary>method that takes a list of all objects, iterate through it, and execute methods depending on what interface that item implements (ex: if the item uses IInteractive, the IterateAction method should call Interact() on it)</summary>
